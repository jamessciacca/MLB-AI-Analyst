...
from features import CONFIG, FEATURE_NAMES, TARGET, prepare_training_frame, split_time_ordered


def train_model(frame, calibrate: bool = True):
    """Train a regularized logistic baseline with optional probability calibration."""
